...
sigma = 0.5;
n_contour = 11;
sample_y = linspace(minP,maxP,n_contour);
sample_x = 1.4:-0.01:0;
f = (maxP-minP)*exp(-1/2*sample_x.^2/sigma^2)+minP;
k = nan(1,n_contour-1);
...
for i = 1:n_contour-1
    ...
    fprintf(fid,'reaction compartment=cmpt_%d Attached_actin_%g Actin + Cdc42T -> complex_Attached_actin_Cdc42T\n',i,i);
    fprintf(fid,'reaction_probability Attached_actin_%g %g\n',i,k(i));
    fprintf(fid, 'binding_radius Attached_actin_%g rho\n',i);

    fprintf(fid,'reaction surface=surf_%d Attached_actin_on_surf_%g Actin + Cdc42T -> complex_Attached_actin_Cdc42T\n',i,i);
    fprintf(fid,'reaction_probability Attached_actin_on_surf_%g %g\n',i,k(i));
    fprintf(fid,'binding_radius Attached_actin_on_surf_%g rho\n',i);
end
...
fprintf(fid,'reaction Attached_actin_dissociation Attached_actin -> Actin k9b\n');
